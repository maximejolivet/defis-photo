...
import { LogOut, Camera as UploadIcon, Grid, Calendar, User as UserIcon, Trash2, X } from 'lucide-react';
...
const Gallery = () => {
    ...
    return (
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 20px' }}>
            <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px', flexWrap: 'wrap', gap: '16px' }}>
                ...
                <div style={{ display: 'flex', gap: '16px' }}>
                    <Link to="/upload" className="btn-primary">
                        <UploadIcon size={20} />Réalise un défi
                    </Link>
            ...
            <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '6px' }}>Mes photos réalisées</h2>
            {
                loading ? (
